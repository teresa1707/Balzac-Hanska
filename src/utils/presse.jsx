export const presse = [
    ...
    {
        id: 4,
        title: 'Les tribulations de Balzac en Ukraine',
        image: '/Images/Balzac-Image.jpg',
        shortText: 'Le Monde - reportage',
        link: 'https://www.lemonde.fr/international/article/2022/07/07/les-tribulations-de-balzac-en-ukraine_6133679_3210.html',
    },
    {
        id: 1,
