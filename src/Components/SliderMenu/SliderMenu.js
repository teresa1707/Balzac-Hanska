...
export const SliderMenu =()=>{
    ...
    return(
        <>
{/* <div id="hero">
  <img src={Balzac} alt="hero desktop" title="hero desktop"/>
</div> */}
<div className = 'fond' id="tables">
...
<p >N’hésitez pas à nous contacter, nous sommes à votre disposition&nbsp;</p>
  ...
  <div className="product two">
    <p className="content">
      Browse in store or online to bring a tremendous table into your space at a jaw dropping price
    </p>
  </div>

</div>

<a href="#" className='shopBtn'>Go Shopping</a>
