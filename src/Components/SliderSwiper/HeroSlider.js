...
export const HeroSlider=()=>{
 ...
 <div id="parallax-container">
    ...
    <div className="parallax-two">
      <Link to="/culture" style={{}}><h2>Projets Culturels</h2></Link>
    </div>
  
  
    
    <Grid container className="block3" id="block2" spacing={4}>
     <Grid item xs={12} md={6}><p><span className="first-character ny">L</span>e 24 février 2022, la Russie a déclaré la guerre à l’Ukraine. Cette invasion a jeté sur les routes plus de 10 millions de personnes (en majorité des femmes, des enfants et des personnes âgées). Plus de sept millions de personnes ont été déplacées et sont actuellement en Ukraine complétement déracinées. Certaines personnes issues de villes détruites à plus de 90 % (Kharkiv, Marioupol, Tchernihiv, Borodianka, Severodonetsk…) s’installent dans des zones où elles pensent être en sécurité comme l’Ouest et le Sud-Ouest du pays. </p>
      ...
      <Grid item xs={12} md={6}><p className="margin-top-10">C’est pourquoi, l’Association franco-ukrainienne « Balzac-Hanska », representé par son président Jean ROCHE et ses nombreux partenaires, se sont engagés à apporter de l’aide aux populations déplacées vers les zones dans lesquelles nous sommes présents. 
</p></Grid><p className="line-break margin-top-10"></p>
</Grid>
    ...
    <Grid container className="block" id="block3" spacing={4}>
      <Grid item xs={12} md={6}>
      <p><span className="first-character atw">N</span>ous ne sommes pas seuls dans cette mission . Avec nos partenaires, volontaires basés en France et volontaires ukrainiens basés à Berdytchiv nous mettont tout en oeuvre afin de faciliter le peuple ukrainien à traverser cette periode dramatique.</p></Grid>
      <Grid item xs={12} md={6}>
