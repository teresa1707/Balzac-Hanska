...
export const Header = ({buttonText}) => {
  ...
  buttonText = "Faire un don ou adherer"
    ...
    <Grid item xs={12} className="annonceImpot" id="easing">L’Association Franco Ukrainienne BALZAC HANSKA est une Association loi de 1901 N° W941007660 – ouvrant droit à une réduction d’impôt et délivrance d’un certificat de déductibilité fiscale. </Grid>
