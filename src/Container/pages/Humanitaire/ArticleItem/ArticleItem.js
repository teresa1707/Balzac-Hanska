...
export const ArticleItem=({ 
  ...
  return(
    ...
    <Grid container className="articleItem "><Grid item sm={12} md={6}><img src="../../../public/Images/khust.jpg"  alt="photoKhust"/></Grid><Grid item sm={12} md={6}><p>Le 24 février 2022, la Russie a déclaré la guerre à l’Ukraine. Cette invasion a jeté sur les routes plus de 10 millions de personnes (en majorité des femmes, des enfants et des personnes âgées). Trois millions ont d’ores et déjà quitté le pays et se sont réfugiés, pour la plupart en Europe de l’Ouest. Cette présence fait peser sur les pays hôtes une charge économique et sociale non négligeable. Mais ce sont plus de sept millions de personnes qui ont été déplacées et sont actuellement en Ukraine complétement déracinées. Certaines personnes issues de villes détruites à plus de 90 % (Kharkiv, Marioupol, Tchernihiv, Borodianka, Severodonetsk…) s’installent dans des zones où elles pensent être en sécurité comme l’Ouest et le Sud-Ouest du pays.</p>    
